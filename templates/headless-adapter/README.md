...
Use the built-in suite as the first CI gate for adapter input translation. Keep renderer frame
loops, `wgpu`, egui, Fret, screenshots, and pixel checks in adapter-specific crates or test suites.
