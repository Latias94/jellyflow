...
viewport pan, sampled viewport animation frames, double-click zoom planning, and sampled viewport
pan inertia before rendering. Keep renderer frame loops, animation cancellation policy, `wgpu`,
egui, Fret, screenshots, and pixel checks in adapter-specific crates or test suites.
